defmodule Day17 do
    ...
    def part1 do
        start_new_rock(input(), %{}, 0, 0, fn _, r, _ -> r == 2022 end)
    end
    ...
    def part2 do
        start_new_rock(input(), %{}, 0, 0, fn _, _, _ -> false end)
        #1_000_000_000_000
        #{board.height, r, i}
    end
end

Day17.part1() |> IO.inspect(label: "part1")
Day17.part2() |> IO.inspect(label: "part2", limit: :infinity)